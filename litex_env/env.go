...
type Env struct {
	...
	CondFactMem  mem.CondFactMemory
	RelaFactMem  mem.RelaFactMemory
	UniFactMem   mem.UniFactMemory
	EqualFactMem mem.EqualFactMemory
}
...
func NewEnv(parent *Env) *Env {
	env := &Env{
		...
		UniFactMem:   mem.UniFactMemory{},
		EqualFactMem: mem.EqualFactMemory{Mem: *ds.NewRedBlackTree(cmp.EqualFactMemoryTreeNodeCompare)},
	}
