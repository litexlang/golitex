...
func (ver *Verifier) specFactOrEqualFact_SpecMode(stmt *ast.SpecificFactStmt, state *VerState) (bool, error) {
	return ver.VerFactStmt(stmt, state.GetFinalRound()).ToBoolErr()
}

func (ver *Verifier) verSpecFact_BySpecMem(stmt *ast.SpecificFactStmt, state *VerState) VerRet {
...
func (ver *Verifier) verSpecFact_ByLogicMem(stmt *ast.SpecificFactStmt, state *VerState) VerRet {
...
func (ver *Verifier) verSpecFact_InSpecFact_UniMem(stmt *ast.SpecificFactStmt, state *VerState) (bool, error) {
	upMostEnv := ver.todo_theUpMostEnvWhereRelatedThingsAreDeclared(stmt)
...
func (ver *Verifier) verSpecFact_InLogicExpr_InUniFactMem(stmt *ast.SpecificFactStmt, state *VerState) (bool, error) {
	upMostEnv := ver.todo_theUpMostEnvWhereRelatedThingsAreDeclared(stmt)
...
func (ver *Verifier) specFact_inLogicExpr_inUniFactMem_atEnv(curEnv *env.Env, stmt *ast.SpecificFactStmt, state *VerState) (bool, error) {
...
func (ver *Verifier) iterate_KnownSpecInLogic_InUni_applyMatch_new(stmt *ast.SpecificFactStmt, knownFacts []env.SpecFact_InLogicExpr_InUniFact, state *VerState) (bool, error) {
...
func (ver *Verifier) specFact_UniMem_atCurEnv(curEnv *env.Env, stmt *ast.SpecificFactStmt, state *VerState) (bool, error) {
...
func (ver *Verifier) SpecFactSpecUnderLogicalExpr(knownFact *env.KnownSpecFact_InLogicExpr, stmt *ast.SpecificFactStmt, state *VerState) (bool, error) {
...
func (ver *Verifier) specFact_SpecMem_atEnv(curEnv *env.Env, stmt *ast.SpecificFactStmt, state *VerState) (bool, error) {
...
func (ver *Verifier) specFact_LogicMem(curEnv *env.Env, stmt *ast.SpecificFactStmt, state *VerState) (bool, error) {
...
func (ver *Verifier) iterateKnownSpecFacts_applyFcEqualSpec(stmt *ast.SpecificFactStmt, knownFacts []ast.SpecificFactStmt, state *VerState) (bool, error) {
LoopOverFacts:
	for _, knownFact := range knownFacts {
...
func (ver *Verifier) matchTwoSpecFacts(stmt *ast.SpecificFactStmt, knownFact *ast.SpecificFactStmt, state *VerState) (bool, error) {
...
func (ver *Verifier) useKnownOrFactToProveSpecFact(knownFact *env.KnownSpecFact_InLogicExpr, stmt *ast.SpecificFactStmt, state *VerState) (bool, error) {
	ver.newEnv(ver.env)
...
func (ver *Verifier) verify_specFact_when_given_orStmt_is_true(stmt *ast.SpecificFactStmt, orStmt *ast.OrStmt, index int, state *VerState) (bool, error) {
	ver.newEnv(ver.env)
	defer ver.deleteEnvAndRetainMsg()
...
func (ver *Verifier) iterate_KnownSpecInUniFacts_applyMatch_new(stmt *ast.SpecificFactStmt, knownFacts []env.KnownSpecFact_InUniFact, state *VerState) (bool, error) {
	for i := len(knownFacts) - 1; i >= 0; i-- {
