...
This README is for examples and comparisons with Lean, the mainstream formal language. I will show you how Litex is shaped by common sense, and why common sense is not so common in traditional formal languages. It must be noted that making Litex so common sense is a very uncommon, because it requires a deep understanding of both the nature of mathematics and the nature of programming.
...
There are and only are two ways of deriving new facts from established ones:
