...
// func NewVerRet(retType StmtRetType, stmtStr string, provedByFactOnLine uint, verifyMsgs []string) *VerRet {
// 	return &VerRet{
// 		RetType:            retType,
// 		StmtStr:            stmtStr,
...
// // ToStmtRet converts ast.VerRet to StmtRet for compatibility
