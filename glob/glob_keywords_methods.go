...
func IsBuiltinInfixRelaPropSymbol(op string) bool {
	return op == KeySymbolEqual || op == KeySymbolLess || op == KeySymbolGreater || op == KeySymbolEqualEqual || op == KeySymbolNotEqual || op == KeySymbolLargerEqual || op == KeySymbolLessEqual
}
