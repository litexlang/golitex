...
func RunCodeInPkgMgr(code string, pkgMgr *packageMgr.PkgMgr, removeBuiltinEnv bool) (*env.EnvMgr, glob.StmtRetType, []ast.StmtRet) {
	...
	for _, block := range blocks {
		...
		if ret.IsNotTrue() {
			return nil, ret.RetType, []ast.StmtRet{ret}
		} else {
