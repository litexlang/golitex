...
func FormatCode(path string) (*glob.StmtRet, error) {
	...
	return glob.NewStmtTrueWithVerifyProcess(glob.NewVerMsg2(glob.StmtRetTypeTrue, fmt.Sprintf("formatted code written to %s", path), glob.BuiltinLine0, []string{})), nil
}
