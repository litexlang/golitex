...
// 	stmtSlice, err := ast.ParseSourceCode(code, curExec.Env.EnvPkgMgr.PkgMgr.CurPkgDefaultName_EmptyWhenREPL, curExec.Env.EnvPkgMgr.PkgMgr, dir)
// 	if err != nil {
// 		return glob.NewGlobErr(err.Error()).AddMsg(glob.REPLErrorMessageWithPath(path))
// 	}
...
// 	importAbsRepoPath := filepath.Join(curExec.Env.EnvPkgMgr.PkgMgr.CurRepoAbsPath_EmptyWhenREPL, importRelativePath)
...
// 	previousEntranceRepoPath := curExec.Env.EnvPkgMgr.PkgMgr.CurRepoAbsPath_EmptyWhenREPL
// 	previousCurPkgName := curExec.Env.EnvPkgMgr.PkgMgr.CurPkgDefaultName_EmptyWhenREPL
// 	curExec.Env.EnvPkgMgr.PkgMgr.CurRepoAbsPath_EmptyWhenREPL = importAbsRepoPath
// 	curExec.Env.EnvPkgMgr.PkgMgr.CurPkgDefaultName_EmptyWhenREPL = importDirStmt.AsPkgName
// 	defer func() {
// 		curExec.Env.EnvPkgMgr.PkgMgr.CurRepoAbsPath_EmptyWhenREPL = previousEntranceRepoPath
// 		curExec.Env.EnvPkgMgr.PkgMgr.CurPkgDefaultName_EmptyWhenREPL = previousCurPkgName
// 	}()
...
// 	for pkgPath, pkgEnv := range curExec.Env.EnvPkgMgr.AbsPkgPathEnvMap {
// 		if _, ok := curExec.Env.EnvPkgMgr.AbsPkgPathEnvMap[pkgPath]; ok {
// 			continue
// 		}
// 		curExec.Env.EnvPkgMgr.AbsPkgPathEnvMap[pkgPath] = pkgEnv
// 	}

// 	// 使用 PathNameMgr 的 Merge 方法合并包名映射
// 	if err := curExec.Env.EnvPkgMgr.PkgMgr.Merge(curExec.Env.EnvPkgMgr.PkgMgr); err != nil {
// 		return glob.NewGlobErr(err.Error())
// 	}
...
// 	envPkgMgr := curExec.Env.EnvPkgMgr // REMARK 直接把现在的pkgMgr传进去，因为已经把entrance repo path改成importAbsRepoPath了
...
// 	previousCurDefaultPkgName := executorToRunDir.Env.EnvPkgMgr.PkgMgr.CurPkgDefaultName_EmptyWhenREPL
// 	executorToRunDir.Env.EnvPkgMgr.PkgMgr.CurPkgDefaultName_EmptyWhenREPL = importDirStmt.AsPkgName
// 	defer func() {
// 		executorToRunDir.Env.EnvPkgMgr.PkgMgr.CurPkgDefaultName_EmptyWhenREPL = previousCurDefaultPkgName
// 	}()
...
// 	err = curExec.Env.EnvPkgMgr.MergeGivenExecPkgMgr(importAbsRepoPath, importDirStmt.AsPkgName, executorToRunDir.Env)
// 	if err != nil {
// 		return glob.NewGlobErr(err.Error())
// 	}
...
// 	workingEnvPath := curExec.Env.EnvPkgMgr.PkgMgr.CurRepoAbsPath_EmptyWhenREPL
