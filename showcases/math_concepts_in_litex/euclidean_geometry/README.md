...
```bash
target/release/litex -compact -runner -r scratch/math_concepts_in_litex/euclidean_geometry
```
...
```sh
lean showcases/math_concepts_in_litex/euclidean_geometry/same_math_in_lean.lean
```
