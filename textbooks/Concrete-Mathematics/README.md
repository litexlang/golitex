...
```text
target/release/litex -compact -runner -r scripts/Concrete-Mathematics-A-Foundation-For-Computer-Science/textbook
```

The exported namespaces are `chap1`, `chap2`, and `chap3`, in source order.
The module provides callable recurrence, finite-sum, summation-factor,
