...
is presently blocked. A checked local recursive proof exists in the published
snapshot and has now been restored in the canonical draft.
...
is checked in the canonical draft.
...
inverse exponents; the proof is checked in the canonical draft.
