...
suppose max_of_finite_set fn(s power_set(R): $is_finite_set(s)) R
suppose min_of_finite_set fn(s power_set(R): $is_finite_set(s)) R
...
suppose min_of_N_set fn(s power_set(N): $is_nonempty_set(s)) N
