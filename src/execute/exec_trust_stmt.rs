...
impl Runtime {
    ...
    /// its environment phase checks each fact before assuming it. All facts and
    /// their inferred consequences are committed atomically; strict mode rejects
    /// the statement before that environment phase.
