...
pub use obj::{
    ...
    ObjAsStructInstanceWithFieldAccess, ObjAtIndex, Pow, PowerSet, Product, Proj, Range, SeqSet,
    SetBuilder, SetDiff, SetMinus, Sqrt, StructObj, Sub, Sum, Tuple, TupleDim, Union,
};
