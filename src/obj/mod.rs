...
pub use free_param_obj::{
    ...
    struct_instance_field_access_obj_for_binding, ByInducFreeParamObj, DefAlgoFreeParamObj,
    DefHeaderFreeFieldAccessObj, DefHeaderFreeParamObj, ExistFreeParamObj, FnSetFreeParamObj,
    ForallFieldAccessObj, ForallFreeParamObj, InstObjState, ParamObjType, SetBuilderFreeParamObj,
