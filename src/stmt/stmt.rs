...
impl Stmt {
    pub fn line_file(&self) -> (usize, usize) {
        match self {
            ...
            Stmt::DefPropWithoutMeaningStmt(stmt) => stmt.line_file,
            ...
            Stmt::DefStructWithNoFieldStmt(stmt) => stmt.line_file,
    ...
    pub fn stmt_type_name(&self) -> String {
        match self {
            ...
            Stmt::DefPropWithoutMeaningStmt(stmt) => stmt.stmt_type_name(),
            ...
            Stmt::DefStructWithNoFieldStmt(stmt) => stmt.stmt_type_name(),
