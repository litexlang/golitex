...
func ParseSourceCode(code string, curPkgNameMaybeNotDefault string, pkgPathNameMgr *pkgMgr.AbsPathNameMgr) ([]Stmt, error) {
	...
	ret := []Stmt{}
	p := NewTbParser(defaultPkgName, pkgPathNameMgr)
