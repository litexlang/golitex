...
func NewProveIsCommutativePropStmt(prop FcAtom, params []string, proofs []Stmt, line uint) *ProveIsCommutativePropStmt {
	return &ProveIsCommutativePropStmt{prop, params, proofs, line}
}
