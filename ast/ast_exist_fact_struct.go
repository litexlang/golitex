...
// func NewExistStFact(isTrue bool, propName Atom, isPropTrue bool, existFreeParams []string, existFreeParamSets []Obj, params []Obj, line uint) *ExistSpecificFactStmt {
// 	return NewExistSpecificFactStmt(isTrue, isPropTrue, propName, existFreeParams, existFreeParamSets, params, line)
// }

// func (s *ExistSpecificFactStmt) ToExistStFact() *PureSpecificFactStmt {
// 	params := []Obj{}
