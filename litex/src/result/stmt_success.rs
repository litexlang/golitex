...
pub struct FactVerifiedByFact {
    ...
    pub infers: InferResult,
    pub line_file_index: Option<(usize, usize)>,
    pub verified_by_line_file: Option<(usize, usize)>,
}
...
impl FactVerifiedByFact {
    pub fn new(fact: String, verified_by: String, infers: InferResult, line_file_index: Option<(usize, usize)>, verified_by_line_file: Option<(usize, usize)>) -> Self {
...
impl FactVerifiedByBuiltinRules {
    pub fn new(fact: String, verified_by: String, infers: InferResult, line_file_index: Option<(usize, usize)>, verified_by_line_file: Option<(usize, usize)>) -> Self {
        FactVerifiedByBuiltinRules { fact, verified_by, infers, line_file_index, verified_by_line_file }
    }
}