...
pub struct FnSetWithDom {
    ...
    pub dom_facts: Vec<MatchableFactWithAtomicFactInside>,
    pub ret_set: Box<Obj>,
}
...
impl SetBuilder {
    pub fn new(param: String, param_set: Obj, facts: Vec<MatchableFactWithAtomicFactInside>) -> Self {
        SetBuilder {
            param: param,
...
impl FnSetWithDom {
    pub fn new(params_and_their_sets: Vec<ParamDefWithParamSet>, dom_facts: Vec<MatchableFactWithAtomicFactInside>, ret_set: Obj) -> Self {
        FnSetWithDom {
