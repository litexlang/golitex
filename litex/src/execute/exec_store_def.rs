...
impl<'a> Executor<'a> {
    ...
    pub fn store_def_prop_without_meaning(&mut self, def_prop_without_meaning_stmt: &DefPropWithoutMeaningStmt) -> Result<(), ExecError> {
    ...
    pub fn store_def_algo(&mut self, def_algo_stmt: &DefAlgoStmt) -> Result<(), ExecError> {
    ...
    pub fn store_identifier_obj(&mut self, name: &str) -> Result<(), ExecError> {
    ...
    pub fn store_def_struct_with_fields(&mut self, def_struct_with_fields_stmt: &DefStructWithFieldsStmt) -> Result<(), ExecError> {
    ...
    pub fn store_def_struct_with_no_field(&mut self, def_struct_with_no_field_stmt: &DefStructWithNoFieldStmt) -> Result<(), ExecError> {
