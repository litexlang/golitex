...
// func glob.NewGlobErr(s string) *ExecErr {
// 	return &ExecErr{Msg: []string{s}}
// }

// func glob.NewGlobErrWithErr(err error) *ExecErr {
// 	return &ExecErr{Msg: []string{err.Error()}}
// }

// func BoolErrToExecRet(ok bool, err error) ExecRet {
// 	if err != nil {
// 		return glob.NewGlobErrWithMsgs([]string{err.Error()})
// 	}
// 	if ok {
// 		return glob.NewGlobTrueWithMsgs([]string{})
// 	}
// 	return glob.NewGlobUnknownWithMsgs([]string{})
// }

// func glob.NewGlobTrue(s string) ExecRet {
// 	return &ExecTrue{Msg: []string{s}}
// }

// func glob.NewEmptyGlobUnknown() ExecRet {
// 	return &ExecUnknown{Msg: []string{}}
// }

// func glob.NewEmptyGlobErr() ExecRet {
// 	return &ExecErr{Msg: []string{}}
// }

// func glob.NewEmptyGlobTrue() ExecRet {
// 	return &ExecTrue{Msg: []string{}}
// }

// func glob.NewGlobUnknown(s string) ExecRet {
// 	return &ExecUnknown{Msg: []string{s}}
// }

// func glob.NewGlobTrueWithValues(s string, equalValue []ast.Obj) ExecRet {
// 	if s != "" {
// 		return &ExecTrue{Msg: []string{s}}
// 	}
// 	if len(equalValue) != 2 {
...
// func glob.NewGlobTrueWithMsgs(msgs []string) ExecRet {
// 	return &ExecTrue{Msg: msgs}
// }

// func glob.NewGlobErrWithMsgs(msgs []string) ExecRet {
// 	return &ExecErr{Msg: msgs}
// }

// func glob.NewGlobUnknownWithMsgs(msgs []string) ExecRet {
