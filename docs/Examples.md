...
7. [Standard Library](#standard-library) - use this as a sampler for public standard-library APIs after you understand the core language.
...
#### 3. Temporary Assumptions With `suppose`
...
Small examples for public standard-library interfaces. This is an API sampler,
not a learning starting point; read it after the core examples when you want to
see the first useful calls into `std`.
...
### 7. Modular Arithmetic With `ZMod`
