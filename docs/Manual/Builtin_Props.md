...
Try all snippets in browser: https://litexlang.com/doc/Manual/Builtin_Props

Markdown source: https://github.com/litexlang/golitex/blob/main/docs/Manual/Builtin_Props.md
