...
Try all snippets in browser: https://litexlang.com/doc/Manual/Builtin_Inference

Markdown source: https://github.com/litexlang/golitex/blob/main/docs/Manual/Builtin_Inference.md
